...
def dfs_search_v1(graph: dict, start: any, target: any) -> bool:
    """
    Checks if a target node is reachable from a start node using DFS.
    ...
    """
    visited = set()
    stack = [start]  # FIX: Initialize stack as a list
